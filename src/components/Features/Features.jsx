...
// import { Tabs, Tab, Alert, Stack, Button } from "react-bootstrap";
...
//             embedder:
//                 this.props.jobParameters.embedder || "prottrans_t5_xl_u50",
...
//                                     💡 Interactive page (3D structure and
//                                     residue features)
//                                 </Button>
//                             </a>
//                         </p>

//                         <p>Navigate to desired features:</p>
//                         <Navigation
//                             className=""
//                             onSelect={({ itemId }) => {
...
//                         <p>
//                             The following feature viewer is a compact
//                             representation of residue-level predicted features.{" "}
//                             {""}
//                             You can find details about the methods mentioned in
...
//                         >
//                             Visualize residue-features and associated legends in
...
//                 {this.isValidIdentifierOrSequence() && (
//                     <div
//                         ref={this.residueLandscapeFeaturesRef}
//                         style={{ textAlign: "justify" }}
//                     >
//                         <MDBTypography tag="h3">
//                             Single Amino acid Variant (SAV) effect
//                         </MDBTypography>
//                         <p>
//                             The following visualization displays the effect of
//                             substituting the residue at position X on the x-axis
//                             with amino acid Y on the y-axis. {""}
//                             Darker color / higher value indicates more
//                             significant effect in performing said substitution,
//                             while a lighter color / lower value {""}
//                             indicates a more tolerable substitution. The orange
//                             dotted marks indicate the wild-type residue at the
//                             given position, for which the substitution effect{" "}
//                             {""}
//                             score is null. SAV effect was computed using the
//                             VESPAi method.
//                         </p>
//                         <VariationPrediction data={this.state.features} />
//                         <p>
//                             You may click and pan the visualization to move
//                             along the x-axis.
//                         </p>
...
//                         <p>
//                             The 3D protein structure is either fetched from the
//                             AlphaFold Database (only available when inputting a
//                             UniProt Accession, e.g. P12004) or predicted via
//                             ColabFold. The first time you submit a sequence
//                             which our server has not yet processed {""}
//                             predicting its structure may take several minutes.{" "}
//                             {""}
//                             The prediction is started in the background and the
//                             visualization below will automatically update once
//                             results are available (no need to refresh the page).
//                         </p>
...
//                                 target={"_blank"}
//                             >
//                                 💡 Interactively explore the predicted features
//                                 on the structure!
//                             </a>
//                         </Alert>
//                     </div>
